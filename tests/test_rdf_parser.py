...
@pytest.fixture
def catalog_data():
    with open("test_data/rdf_catalog.ttl", "r") as f:
        return f.read()


@pytest.fixture
def dataset1_data():
    with open("test_data/rdf_dataset1.ttl", "r") as f:
        return f.read()


@pytest.fixture
def dataset2_data():
    with open("test_data/rdf_dataset2.ttl", "r") as f:
        return f.read()
...
def test_publisher_generator(parser):
    ...
    with open("test_data/extraction_foaf_organization.ttl", "r") as f:
...
def test_kind_generator(parser):
    ...
    with open("test_data/extraction_vcard_contact.ttl", "r") as f:
        parser.parse(data=f.read(), _format="turtle")
...
def test_provenancestatement_generator(parser):
    ...
    with open("test_data/extraction_provenancestatement.ttl", "r") as f:
        parser.parse(data=f.read(), _format="turtle")
