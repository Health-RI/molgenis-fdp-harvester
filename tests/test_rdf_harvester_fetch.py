...
def test_fetch_concept_without_name(harvester, empty_harvestobject_dataset):
    ...
    # Setup test data
    mock_concept = {"uri": "http://example.com/dataset1", "id": "existing-id", "title": "Test Dataset"}
...
def test_fetch_concept_without_id(harvester, empty_harvestobject_dataset):
    ...
    # Setup test data
    mock_concept = {"uri": "http://example.com/dataset1", "name": "test-name", "title": "Test Dataset"}
...
def test_fetch_concept_dataset_auto_create_disabled(harvester, empty_harvestobject_dataset):
    ...
    # Setup test data
    mock_concept = {"uri": "http://example.com/dataset1", "name": "test-dataset", "id": "test-id"}
...
def test_fetch_concept_non_dataset_not_tracked(harvester):
    ...
    harvest_object = HarvestObject(guid="http://example.com/kind1", content=None, concept_type="kind")

    mock_concept = {"uri": "http://example.com/kind1", "name": "test-kind", "id": "test-id"}
...
def test_generate_missing_datasetseries_updates_datasets(harvester):
    ...
    dataset = HarvestObject(
        guid="http://example.com/dataset1", content=json.dumps({"name": "test-dataset", "title": "Test Dataset"})
    )
